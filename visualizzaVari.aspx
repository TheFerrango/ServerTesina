<%@ Page Language="C#" AutoEventWireup="true" CodeFile="visualizzaVari.aspx.cs" Inherits="visualizzaVari" %>
    ...
    <div id="page">
        <div id="content">
            <div class="post">
                ...
                <br />
                <p class="byline">
                    <asp:Button ID="addBtn" runat="server" Text="Aggiungi" OnClick="addBtn_Click" />
